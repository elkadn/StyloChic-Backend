...
public class LigneAchatDTO {
    ...
    public LigneAchatDTO(Long id, String taille, int quantite, Double prixHT, Double prixTTC, Double tva, Long idProduit, String imageProduit, String couleurProduit, Double prixProduitHT, Double tvaProduit, Double prixProduitTTC, Double prixProduitReduit, String saisonProduit, Double pourcentageReductionProduit, String titreProduit, String descriptionProduit, String conseilEntretienProduit) {
        this.id = id;
        this.taille = taille;
