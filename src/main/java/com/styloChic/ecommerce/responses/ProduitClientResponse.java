...
public class ProduitClientResponse {
    ...
    public ProduitClientResponse(Long id, String titre, String description, double tva, double prixVenteHT, double prixVenteTTC, String categorieParente, String categorieMoyenne, String categorieBase, int quantiteEnStock, String imagePrincipale, String saison, String conseilEntretien, String nomCouleur, Set<Taille> tailles, List<ImageProduit> imagesProduit, List<Vote> votes, List<Avis> avis, int total_votes, int total_avis) {
        this.id = id;
        this.titre = titre;
